...
enum class Stabilisierung { KEINE, VORSCHAU, NUR_VIDEO }
 ...
 */
fun waehleStabilisierung(
    fuerVideo: Boolean,
    vorschauMoeglich: Boolean,
    videoMoeglich: Boolean,
): Stabilisierung = when {
    !fuerVideo -> Stabilisierung.KEINE
    vorschauMoeglich -> Stabilisierung.VORSCHAU
    videoMoeglich -> Stabilisierung.NUR_VIDEO
    else -> Stabilisierung.KEINE
}
