...
import app.maptale.ui.scaleToEdge
import app.maptale.ui.sampleFactor
import java.io.File
...
fun preparePhotoForUpload(datei: File) {
    ...
    runCatching {
        ...
        val schonKlein = maxOf(masse.outWidth, masse.outHeight) <= UPLOAD_EDGE
