...
class AndroidGeocoder(private val context: Context) : PlaceGeocoder {
    override suspend fun placeName(lat: Double, lng: Double): String? {
...
class TourNaming(private val geocoder: PlaceGeocoder) {
    ...
    companion object {
        ...
        fun fallbackTitle(startMs: Long, zone: String): String {
