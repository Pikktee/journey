...
class ActivityInterpretationTest {
    ...
    fun `haelt eine saubere Folge unveraendert`() {
        ...
        assertEquals(roh, ActivityInterpretation.smooth(roh, endeS = 1800.0))
    }
    ...
    fun `wirft das Flackern beim Umsteigen weg`() {
        ...
        assertEquals(listOf(a(0.0, TravelMode.JEEP)), ActivityInterpretation.smooth(roh, endeS = 1800.0))
    }
    ...
    fun `behaelt einen echten Fussweg zwischen zwei Fahrten`() {
        ...
        assertEquals(roh, ActivityInterpretation.smooth(roh, endeS = 2700.0))
    }
    ...
    fun `verschmilzt gleiche Nachbarn`() {
        ...
        assertEquals(
            ...
            ActivityInterpretation.smooth(roh, endeS = 1800.0),
        )
    }
    ...
    fun `kommt mit leerer Eingabe klar`() {
        assertEquals(emptyList<TravelModeSegment>(), ActivityInterpretation.smooth(emptyList(), endeS = 100.0))
    }
}
