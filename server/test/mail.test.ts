...
describe('Vorlagen-Katalog', () => {
  it('kennt vier System-Mails, jede mit Standardtext und Platzhaltern', () => {
    expect(VORLAGEN.map((v) => v.schluessel)).toEqual(['verifikation', 'reset', 'warteliste', 'warteliste-einladung'])
