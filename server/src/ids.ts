...
export const newTourId = (): string => `t_${nano()}`
...
export const newMediumId = (): string => `n_${nanoKurz()}`
export const newUserId = (): string => `u_${nano()}`
...
export const newDataExportId = (): string => `x_${nano()}${nano()}`
export const newTokenSecret = (): string => `lhb_${nano()}${nano()}${nano()}`
...
export const newInvitationCode = (): string => `${codeNano()}-${codeNano()}`
