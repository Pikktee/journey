...
* [Bezeichner auf Englisch](concepts/konzept_codebase_english_refactoring.md) - Wellen 0 und 1 sind durch: Verträge, API und App sind englisch, seit dem 2026-08-20 live (v0.67.0). Als Nächstes Welle 2: die Server-Internals (Pipeline, Routen-Handler, Mail-Bausteine, Auth, Dateinamen unter server/src). Ganz am Ende Schritt 9: die Env-Variablen als eigener Ops-Schritt.
