...
* [Bezeichner auf Englisch](concepts/konzept_codebase_english_refactoring.md) - Welle 0: Zahlen aus §4.5 erheben, dann die Abbildungstabelle bauen und abnehmen lassen (§11). Vorher fällt keine Zeile Code. Danach Welle 1: die Verträge samt API. Ganz am Ende Schritt 9: die Env-Variablen als eigener Ops-Schritt.
