...
* [Bezeichner auf Englisch](concepts/konzept_codebase_english_refactoring.md) - Wellen 0 bis 4 sind durch: Verträge, API und App seit dem 2026-08-20 live (v0.67.0), am selben Tag die Server-Internals und die DOM-freien Studio-Module, am 2026-08-21 die Studio-Verdrahtung samt Dateinamen, DOM-IDs und CSS-Klassen (editor.ts, studio.ts, playback, export-sheet, add-media, sfx-library, tooltip, map-mood). Als Nächstes Welle 5: die Player-Engine (tour, filmachse, filmuhr, kartenmaler, kartenschicht, einblendung, ui, main, exportfilm …) samt window.__j, den Messskripten unter scripts/messungen und stopps.ts. Ganz am Ende Schritt 9: die Env-Variablen als eigener Ops-Schritt.
