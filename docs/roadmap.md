...
* [Bezeichner auf Englisch](concepts/konzept_codebase_english_refactoring.md) - Wellen 0 bis 6 sind durch, damit ist das WEB fertig: Verträge, API und App seit dem 2026-08-20 live (v0.67.0), am selben Tag die Server-Internals und die DOM-freien Studio-Module, am 2026-08-21 die Studio-Verdrahtung, die Player-Engine und zuletzt die übrigen src-Module (Konto, Profil, Verwaltung, Galerie, die flachen Produktmodule) samt CSS-Blättern, Custom Properties, DOM-Namen und Storage-Schlüsseln. Die Wellen 2 bis 6 warten auf den nächsten Release. Als Nächstes Welle 7: Android (ViewModels, Screens, Services, Enum-Speicherwerte, DataStore-Schlüssel, Room v4). Danach Welle 8 (Doku) und ganz am Ende Schritt 9: die Env-Variablen als eigener Ops-Schritt.
