...
* [Bezeichner auf Englisch](concepts/konzept_codebase_english_refactoring.md) - Wellen 0 bis 5 sind durch: Verträge, API und App seit dem 2026-08-20 live (v0.67.0), am selben Tag die Server-Internals und die DOM-freien Studio-Module, am 2026-08-21 die Studio-Verdrahtung und die Player-Engine (film-axis, film-clock, card-painter, card-layer, card-timing, ui, main, film-export …) samt window.__maptale, den Messskripten und dem geteilten Verhaltens-Fixture. Als Nächstes Welle 6: die übrigen src-Module (Konto, Profil, Admin, Galerie, die flachen Produktmodule) samt CSS-Dateinamen und den localStorage-Schlüsseln. Ganz am Ende Schritt 9: die Env-Variablen als eigener Ops-Schritt.
