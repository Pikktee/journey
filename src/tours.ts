...
export const TOURS = {
  oberland: {
    ...
    time: {
      start: '2025-06-21T06:15:00+02:00',
      end: '2025-06-21T20:45:00+02:00',
      zone: 'Europe/Zurich',
    },
  ...
  stockholm: {
    ...
    time: {
      start: '2025-08-24T09:30:00+02:00',
      end: '2025-08-24T23:00:00+02:00',
  ...
  kohphangan: {
    ...
    time: {
      start: '2025-05-12T14:00:00+07:00',
      end: '2025-05-13T00:00:00+07:00',
      zone: 'Asia/Bangkok',
    },
    geoid: -31,
    ...
    segments: [
      {
        mode: 'walk',
        label: 'Zu Fuß', // Ankunft in Thong Sala, Bummel durch den Ort
        pts: [
          [99.9856, 9.7133, 6],
          [99.9865, 9.7129, 6],
          [99.9868, 9.71252, 6],
      ...
      {
        mode: 'moped',
        label: 'Moped', // Ort → Thong-Sala-Strand → Südküste (Ao Bang Charu, Haad Baan Tai) → Phaeng-Wasserfall (OSRM driving, dichte Geometrie; kurze Abstecher direkt auf den Sand an den ersten beiden Foto-Stopps)
        pts: [
          [99.9868, 9.71252, 8],
          [99.9865, 9.71246, 8],
          [99.98657, 9.71218, 8],
      ...
      {
        mode: 'walk',
        label: 'Zu Fuß', // Strandweg zum Longtail-Steg
        pts: [
          [100.0582, 9.7702, 4],
          [100.06, 9.7699, 4],
        ],
      ...
      {
        mode: 'ferry',
        label: 'Longtail-Boot', // Longtail die Ostküste hinab, östlich an Haad Rin Nok
        pts: [
          [100.06, 9.7699, 0],
          [100.0605, 9.7725, 0],
          [100.063, 9.7752, 0],
      ...
      {
        mode: 'walk',
        label: 'Zu Fuß', // an Land am Sunrise Beach zur Full Moon Party
        pts: [
          [100.0688, 9.67667, 3],
          [100.0682, 9.67655, 3],
          [100.0678, 9.67635, 3],
