...
const ZEICHEN: Record<string, string> = {
  ...
  instagram: 'M8.6 4h6.8A4.6 4.6 0 0120 8.6v6.8a4.6 4.6 0 01-4.6 4.6H8.6A4.6 4.6 0 014 15.4V8.6A4.6 4.6 0 018.6 4z|M15.6 12a3.6 3.6 0 11-7.2 0 3.6 3.6 0 017.2 0z|M17.4 7.1a.9.9 0 11-1.8 0 .9.9 0 011.8 0z',
