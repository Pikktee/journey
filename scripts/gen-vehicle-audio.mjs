...
const CLIPS = [
  {
    ...
    dur: 16,
    loop: true,
    text: 'Old rugged 4x4 off-road jeep engine running steadily under load on a rough track, low diesel grumble and drivetrain rumble, constant moderate RPM, no revving spikes, no gear changes, no music, no voices',
  },
  {
    name: 'eng-moped',
    dur: 16,
    loop: true,
    text: 'Small Honda Wave 110cc four-stroke single-cylinder underbone motorcycle engine cruising at a steady moderate speed, continuous smooth light engine hum with a soft airy exhaust buzz, constant moderate RPM, no revving, no gear changes, no music, no voices',
  },
  {
    name: 'eng-boat',
    dur: 16,
    loop: true,
    text: 'Loud throaty Thai long-tail boat engine cruising at a steady speed on the open sea, the distinctive exposed car-engine-on-a-pole long-tail motor with a strong rhythmic mechanical chugging putter and a prominent exhaust beat, close-up and clearly audible over the water, constant moderate RPM, no revving, no music, no voices',
  },
