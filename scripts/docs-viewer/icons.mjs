...
export const ICONS = {
  ...
  muenze: [
    ...
    'M12 7v10',
    'M14.5 9.5h-4a1.8 1.8 0 0 0 0 3.5h3a1.8 1.8 0 0 1 0 3.5h-4',
  ],
  globus: [
    'M12 21a9 9 0 1 0 0-18 9 9 0 0 0 0 18z',
    'M3 12h18',
    'M12 3c2.5 2.5 3.7 5.6 3.7 9s-1.2 6.5-3.7 9c-2.5-2.5-3.7-5.6-3.7-9S9.5 5.5 12 3z',
  ],
  brief: ['M3 6h18v12H3z', 'm3 7 9 6 9-6'],
  schluessel: [
    'M7.5 15.2a3.2 3.2 0 1 0 0-6.4 3.2 3.2 0 0 0 0 6.4z',
    'M10.7 12H20',
    'M17 12v3',
    'M20 12v2.5',
  ],
  ...
  tempo: [
    'M4 17a8 8 0 1 1 16 0',
    'm12.6 15.4 3.9-5.4',
    'M12 18a1.4 1.4 0 1 0 0-2.8 1.4 1.4 0 0 0 0 2.8z',
  ],
  ...
  buchstaben: [
    'm4 17 4-10 4 10',
    'M5.4 13.5h5.2',
    'M20 9.5c0-1.1-1-1.7-2.4-1.7-1.6 0-2.6.8-2.6 2s1 1.7 2.6 1.9c1.6.2 2.6.7 2.6 1.9s-1.1 2-2.7 2C15.9 15.6 15 15 15 14',
  ],
