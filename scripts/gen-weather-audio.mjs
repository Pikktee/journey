...
const CLIPS = [
  {
    ...
    dur: 22,
    loop: true,
    text: 'Continuous steady rainfall, moderate rain, ambient background sound of rain hitting the ground and water, no thunder, no music, no voices',
  },
  {
    name: 'storm',
    dur: 22,
    loop: true,
    text: 'Heavy torrential rainstorm, intense downpour with gusting wind, dense ambient rain, no music, no voices',
  },
  {
    name: 'thunder',
    dur: 8,
    loop: false,
    text: 'A single powerful thunderclap with a sharp crack followed by a long deep rumble rolling away into the distance',
  },
  {
    name: 'thunder2',
    dur: 10,
    loop: false,
    text: 'Distant thunder rolling slowly across the sky, low deep rumble far away, no rain sound, no music, no voices',
  },
  {
    name: 'thunder3',
    dur: 6,
    loop: false,
    text: 'Very close violent thunder strike, sudden sharp loud crack like splitting wood, short tail, no music, no voices',
  },
  {
    name: 'wind',
    dur: 22,
    loop: true,
    text: 'Soft cold winter wind blowing gently, calm snowy ambience, light airy whistling, no rain, no music, no voices',
  },
]
